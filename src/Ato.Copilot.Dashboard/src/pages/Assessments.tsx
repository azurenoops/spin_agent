...
=======
      ...
      {taskModalFinding && (
        <CreateRemediationTaskModal
          ...
          initialTitle={taskModalFinding.title}
          initialSeverity={taskModalFinding.severity}
          onClose={() => setTaskModalFinding(null)}
          onCreated={() => setTaskModalFinding(null)}
        />
      )}
>>>>>>> fba3ce3 (fix(#220): TS errors — initialTitle rename, showSarView unused, loadAssessments→refresh, null→undefined)
    </div>
  );
}
