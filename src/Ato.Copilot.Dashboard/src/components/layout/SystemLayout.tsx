...
export const SYSTEM_NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: 'narratives', label: 'Narratives', end: true, d: 'M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25' },
      { path: 'narratives/library', label: 'Narrative Library', d: 'M4 4h6v16H4zM14 4h6v16h-6z' },
  ...
  },
  {
    ...
    primaryFor: ['ISSM', 'AO'],
    items: [
      { path: 'authorize', label: 'Authorize', d: 'M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z' },
      ...
      { path: 'emass/status', label: 'eMASS Workflow', d: 'M7.5 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75h-1.5M7.5 3.75A2.25 2.25 0 019.75 1.5h4.5a2.25 2.25 0 012.25 2.25M7.5 3.75A2.25 2.25 0 009.75 6h4.5a2.25 2.25 0 002.25-2.25M9 12.75l2.25 2.25L15 9.75' },
    ],
  },
];
