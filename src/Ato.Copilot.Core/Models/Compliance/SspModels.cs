...
public class ControlImplementation
{
    ...
    /// <summary>True when current technical/combined text was populated automatically, including templates and model output.</summary>
    public bool IsAutoPopulated { get; set; }

    /// <summary>True after successful model generation of current technical/combined text; not evidence of implementation or approval. Manual Technical replacement clears it; Policy-only edits preserve it. Migrated legacy flags are unverified.</summary>
