...
The following four mock boards and their interpretation guide are published at an immutable commit. Open the file links for full-resolution review and use the embedded previews below.

1. [01-overview-and-implementation.png](https://github.com/azurenoops/spin_agent/blob/7ca7d50085df84b23d70776d1d55316081b8d9e9/docs/design/system-security-capability-mocks/01-overview-and-implementation.png) — views 01–02: system capability list and implementation detail.
2. [02-components-and-library.png](https://github.com/azurenoops/spin_agent/blob/7ca7d50085df84b23d70776d1d55316081b8d9e9/docs/design/system-security-capability-mocks/02-components-and-library.png) — views 03–04: component view/drawer and library selection.
3. [03-coverage-evidence-and-removal.png](https://github.com/azurenoops/spin_agent/blob/7ca7d50085df84b23d70776d1d55316081b8d9e9/docs/design/system-security-capability-mocks/03-coverage-evidence-and-removal.png) — views 05–06: coverage/duties, evidence/narratives and removal confirmation.
4. [04-applicability-and-confirmation.png](https://github.com/azurenoops/spin_agent/blob/7ca7d50085df84b23d70776d1d55316081b8d9e9/docs/design/system-security-capability-mocks/04-applicability-and-confirmation.png) — views 07–08: applicability, final review, success and partial failure.
5. [README.md](https://github.com/azurenoops/spin_agent/blob/7ca7d50085df84b23d70776d1d55316081b8d9e9/docs/design/system-security-capability-mocks/README.md) — interpretation rules and screen index.

![01-overview-and-implementation](https://raw.githubusercontent.com/azurenoops/spin_agent/7ca7d50085df84b23d70776d1d55316081b8d9e9/docs/design/system-security-capability-mocks/01-overview-and-implementation.png)

![02-components-and-library](https://raw.githubusercontent.com/azurenoops/spin_agent/7ca7d50085df84b23d70776d1d55316081b8d9e9/docs/design/system-security-capability-mocks/02-components-and-library.png)

![03-coverage-evidence-and-removal](https://raw.githubusercontent.com/azurenoops/spin_agent/7ca7d50085df84b23d70776d1d55316081b8d9e9/docs/design/system-security-capability-mocks/03-coverage-evidence-and-removal.png)

![04-applicability-and-confirmation](https://raw.githubusercontent.com/azurenoops/spin_agent/7ca7d50085df84b23d70776d1d55316081b8d9e9/docs/design/system-security-capability-mocks/04-applicability-and-confirmation.png)
